...
from albumentations.augmentations.transforms import  VerticalFlip , \
    HorizontalFlip, Flip, Transpose, OpticalDistortion, GridDistortion, Cutout,  \
    Blur, MotionBlur, MedianBlur, Normalize, HueSaturationValue, RGBShift, RandomBrightnessContrast,        \
    GaussNoise, CLAHE, RandomGamma, ToFloat,    \
    PadIfNeeded, RandomFog
...
aug_matcher = {
    ...
    'randomresizedcrop': RandomResizedCrop, 'opticaldistortion': OpticalDistortion,
